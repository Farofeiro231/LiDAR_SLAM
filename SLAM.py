...
if __name__ == '__main__':
    ...
    try:
        ...
        data_plotting = mp.Process(target=plotting, args=(my_queue, keyFlags, xPoints, xInliers, yInliers, ))#keyFlags, theta, distance, xPoints, yPoints, xInliers, yInliers, x, y, ))
